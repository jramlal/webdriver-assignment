...
describe('Unhappy path for verifying order history', () => {
    it('should fail to verify order history without creating an account', async () => {
        ...
        await AccountPage.open(); //tries to open account page to verify order info. 

        await expect(browser).toHaveUrl("https://magento.softwaretestingboard.com/customer/account/login/referer/aHR0cHM6Ly9tYWdlbnRvLnNvZnR3YXJldGVzdGluZ2JvYXJkLmNvbS9jdXN0b21lci9hY2NvdW50L2luZGV4Lw%2C%2C/")
